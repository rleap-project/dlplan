...
TEST(DLPTests, SerializationGripperTest) {
    ...
    Data out_data;
    out_data.m_state_spaces.push_back(state_space_1);
    out_data.m_state_spaces.push_back(state_space_2);
    ...
    EXPECT_NE(in_data.m_state_spaces[0]->get_instance_info(), in_data.m_state_spaces[1]->get_instance_info());
    EXPECT_EQ(in_data.m_state_spaces[0]->get_instance_info()->get_vocabulary_info(), in_data.m_state_spaces[1]->get_instance_info()->get_vocabulary_info());
}
