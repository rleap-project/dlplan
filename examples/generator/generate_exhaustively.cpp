...
int main() {
    ...
    dlp::core::Predicate p3 = vocabulary->add_predicate("clear", 1);
    dlp::core::Predicate p4 = vocabulary->add_predicate("on_g", 2);
    ...
    dlp::core::Atom a6 = instance->add_atom("clear", {"A"});
    dlp::core::Atom a7 = instance->add_atom("clear", {"B"});
    dlp::core::Atom a8 = instance->add_static_atom("on_g", {"A", "B"});
    ...
    dlp::generator::FeatureGenerator generator(factory, 10, 180);
