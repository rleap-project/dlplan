...
def main():
    ...
    assert policy.evaluate_lazy(2, s2, 1, s1)[1]
    assert not policy.evaluate_lazy(2, s2, 0, s0)[1]
    assert not policy.evaluate_lazy(1, s1, 2, s2)[1]
    assert not policy.evaluate_lazy(0, s0, 2, s2)[1]
