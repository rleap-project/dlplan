...
class DomainData:
    ...
    def __init__(self, domain_file):
        ...
        self.tarski_predicates = [predicate for predicate in problem.language.predicates if not isinstance(predicate.symbol, tarski.syntax.builtins.BuiltinPredicateSymbol) and predicate.arity > 0]
