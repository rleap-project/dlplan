...
extern std::pair<std::string, std::shared_ptr<const dlplan::policy::NamedConcept>> parse(const stage_1::ast::ConceptDefinition& node, const dlplan::common::parsers::error_handler_type& error_handler, Context& context);
...
extern std::unordered_map<std::string, std::shared_ptr<const dlplan::policy::NamedConcept>> parse(const stage_1::ast::ConceptsEntry& node, const dlplan::common::parsers::error_handler_type& error_handler, Context& context);

extern std::pair<std::string, std::shared_ptr<const dlplan::policy::NamedRole>> parse(const stage_1::ast::RoleDefinition& node, const dlplan::common::parsers::error_handler_type& error_handler, Context& context);
...
extern std::unordered_map<std::string, std::shared_ptr<const dlplan::policy::NamedRole>> parse(const stage_1::ast::RolesEntry& node, const dlplan::common::parsers::error_handler_type& error_handler, Context& context);
