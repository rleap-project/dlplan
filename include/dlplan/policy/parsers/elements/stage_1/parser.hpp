#ifndef DLPLAN_INCLUDE_DLPLAN_POLICY_PARSERS_ELEMENTS_STAGE_1_PARSER_API_HPP_
#define DLPLAN_INCLUDE_DLPLAN_POLICY_PARSERS_ELEMENTS_STAGE_1_PARSER_API_HPP_
...
namespace dlplan::policy::parsers::elements::stage_1
{
