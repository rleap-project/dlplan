...
def test_generate_exhaustively():
    ...
    states = [s0, s1, s2]
    feature_reprs = generator.generate(factory, 2, 180, 100000, 1, states)
    print(feature_reprs)
