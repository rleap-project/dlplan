...
class NoveltyTable:
    ...
    @overload
    def insert(self, atom_indices: List[int], add_atom_indices: List[int], stop_if_novel: bool = True) -> bool: ...
    @overload
    def insert(self, tuple_indices: List[int], stop_if_novel: bool = True) -> bool: ...


class TupleNode:
    def __init__(self, index: int, tuple_index: int, state_indices: List[int]) -> None: ...
