...
void init_generator(py::module_ &m) {
    py::class_<FeatureGenerator, std::shared_ptr<FeatureGenerator>>(m, "FeatureGenerator")
        ...
        .def("set_generate_role_distance_numerical", &FeatureGenerator::set_generate_role_distance_numerical)
        .def("set_generate_sum_concept_distance_numerical", &FeatureGenerator::set_generate_sum_concept_distance_numerical)
        .def("set_generate_sum_role_distance_numerical", &FeatureGenerator::set_generate_sum_role_distance_numerical)
