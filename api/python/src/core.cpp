...
void init_core(py::module_ &m) {
    ...
    py::class_<Atom>(m, "Atom")
        ...
        .def("get_predicate_idx", &Atom::get_predicate_idx, py::return_value_policy::reference)
        .def("get_object_idxs", &Atom::get_object_idxs, py::return_value_policy::reference)
