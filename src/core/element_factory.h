...
public:
     ...
     */
    element::NumericalElement_Ptr make_count_element(element::ConceptElement_Ptr element);

    /**
     * Returns a NumericalElement that counts the number of roles.
     */
    element::NumericalElement_Ptr make_count_element(element::RoleElement_Ptr element);
     ...
     * Returns a ConceptElement that counts the number of primitive concepts.
     */
    element::ConceptElement_Ptr make_and_concept_element(element::ConceptElement_Ptr element1, element::ConceptElement_Ptr element2);
};
