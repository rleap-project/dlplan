#ifndef DLP_SRC_CORE_PARSER_EXPRESSIONS_ROLES_TRANSITIVE_REFLEXIVE_CLOSURE_H_
#define DLP_SRC_CORE_PARSER_EXPRESSIONS_ROLES_TRANSITIVE_REFLEXIVE_CLOSURE_H_
...
protected:
    virtual element::Role_Ptr parse_role_impl(const VocabularyInfo& vocabulary, ElementCache &cache) const override {
        ...
        // 2. Construct element
        return std::make_shared<element::TransitiveReflexiveClosureRole>(vocabulary, role);
    }
