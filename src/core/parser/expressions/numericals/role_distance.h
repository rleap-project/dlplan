#ifndef DLP_SRC_CORE_PARSER_EXPRESSIONS_NUMERICAL_ROLE_DISTANCE_H_
#define DLP_SRC_CORE_PARSER_EXPRESSIONS_NUMERICAL_ROLE_DISTANCE_H_
...
protected:
    element::Numerical_Ptr parse_numerical_impl(const VocabularyInfo& vocabulary, ElementCache &cache) const override {
        ...
        return std::make_shared<element::RoleDistanceNumerical>(element::RoleDistanceNumerical(vocabulary, role_from, role, role_to));
    }
