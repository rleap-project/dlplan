...
protected:
     ...
     */
    virtual element::RoleElement_Ptr parse_role_element_impl(std::shared_ptr<InstanceInfoImpl> info, ElementCache &cache) const = 0;
...
public:
     ...
     */
    virtual element::RoleElement_Ptr parse_role_element(std::shared_ptr<InstanceInfoImpl> info, ElementCache &cache) const {
