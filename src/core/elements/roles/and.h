...
#include "../utils.h"
#include "../../parser/expressions/roles/and.h"
...
public:
    AndRole(std::shared_ptr<VocabularyInfo> vocabulary_info, ElementIndex index, std::shared_ptr<const Role> role_1, std::shared_ptr<const Role> role_2)
