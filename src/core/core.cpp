...
DenotationsCaches::DenotationsCaches() : m_pImpl(DenotationsCachesImpl()) { }

DenotationsCaches::~DenotationsCaches() = default;

DenotationsCaches::DenotationsCaches(DenotationsCaches&& other)
    : m_pImpl(std::move(*other.m_pImpl)) { }

DenotationsCaches& DenotationsCaches::operator=(DenotationsCaches&& other) {
    if (this != &other) {
