...
bool State::operator==(const State& other) const {
    return (compute_sorted_atom_idxs(get_atom_idxs()) == compute_sorted_atom_idxs(other.get_atom_idxs())) && (get_instance_info() == other.get_instance_info());
}
...
size_t State::hash() const {
    Index_Vec sorted_atom_idxs = compute_sorted_atom_idxs(m_atom_idxs);
