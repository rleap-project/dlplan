...
FeatureGenerator::FeatureGenerator(std::shared_ptr<core::SyntacticElementFactory> factory, int complexity, int time_limit, int feature_limit,
    ...
    : m_pImpl(FeatureGeneratorImpl(factory, complexity, time_limit, feature_limit, generate_empty_boolean, generate_nullary_boolean, generate_all_concept, generate_and_concept, generate_bot_concept, generate_diff_concept, generate_equal_concept, generate_not_concept, generate_one_of_concept, generate_or_concept, generate_primitive_concept, generate_projection_concept, generate_some_concept, generate_subset_concept, generate_top_concept, generate_concept_distance_numerical, generate_count_numerical, generate_role_distance_numerical, generate_sum_concept_distance_numerical, generate_sum_role_distance_numerical, generate_and_role, generate_compose_role, generate_diff_role, generate_identity_role, generate_inverse_role, generate_not_role, generate_or_role, generate_primitive_role, generate_restrict_role, generate_top_role, generate_transitive_closure_role, generate_transitive_reflexive_closure_role)) { }
