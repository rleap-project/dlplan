...
std::function<ConceptTaskResult(const States&, const core::Role&, const core::Concept&)> EqualConcept::m_equal_concept_task =
    [](const States& states, const core::Role& role, const core::Concept& element) {
