...
public:
    ...
    virtual std::shared_ptr<const core::Boolean> parse_boolean(PolicyBuilder&, core::SyntacticElementFactory&) const {
        throw std::runtime_error("Expression::parse_boolean - cannot parse expression into Boolean feature.");
    }

    virtual std::shared_ptr<const core::Numerical> parse_numerical(PolicyBuilder&, core::SyntacticElementFactory&) const {
        throw std::runtime_error("Expression::parse_numerical - cannot parse expression into numerical feature.");
    }
...
public:
    ...
    std::shared_ptr<const core::Boolean> parse_boolean(PolicyBuilder& builder, core::SyntacticElementFactory& factory) const override {
        std::cout << m_children.at(1)->get_name_ref() << std::endl;
        return builder.add_boolean_feature(factory.parse_boolean(m_children.at(1)->get_name_ref()));
    }
};
...
public:
    ...
    std::shared_ptr<const core::Numerical> parse_numerical(PolicyBuilder& builder, core::SyntacticElementFactory& factory) const override {
        return builder.add_numerical_feature(factory.parse_numerical(m_children.at(1)->get_name_ref()));
    }
};
...
public:
    ...
    std::shared_ptr<const Rule> parse_rule(policy::PolicyBuilder& builder, core::SyntacticElementFactory& factory) const override {
...
public:
    ...
    std::shared_ptr<const BaseCondition> parse_condition(PolicyBuilder& builder, core::SyntacticElementFactory& factory) const override {
        ...
        return parse_condition_impl(builder, builder.add_boolean_feature(factory.parse_boolean(m_children.at(1)->get_name_ref())));
    }
};
...
public:
    ...
    std::shared_ptr<const BaseEffect> parse_effect(PolicyBuilder& builder, core::SyntacticElementFactory& factory) const override {
        ...
        return parse_effect_impl(builder, builder.add_boolean_feature(factory.parse_boolean(m_children.at(1)->get_name_ref())));
    }
};
...
public:
    ...
    std::shared_ptr<const BaseCondition> parse_condition(PolicyBuilder& builder, core::SyntacticElementFactory& factory) const override {
        ...
        return parse_condition_impl(builder, builder.add_numerical_feature(factory.parse_numerical(m_children.at(1)->get_name_ref())));
    }
};
...
public:
    ...
    std::shared_ptr<const BaseEffect> parse_effect(PolicyBuilder& builder, core::SyntacticElementFactory& factory) const override {
        ...
        return parse_effect_impl(builder, builder.add_numerical_feature(factory.parse_numerical(m_children.at(1)->get_name_ref())));
    }
};
