...
\begin{tikzpicture}[scale=0.12]
    ...
    \node[draw, rectangle, line width=1pt, align=center] (state) at (15,25) {
        ...
        \end{tikzpicture} \\
        $\boldsymbol{+}$ \\
        $\text{clear}_\text{goal}(\kern-3pt\raisebox{-4pt}{\block{0.12}{red}{}}\kern-3pt)$ \\
        $\text{clear}_\text{goal}(\kern-3pt\raisebox{-4pt}{\block{0.12}{green}{}}\kern-3pt)$ \\
        $\text{clear}_\text{goal}(\kern-3pt\raisebox{-4pt}{\block{0.12}{blue}{}}\kern-3pt)$
    \end{tabular}
    };
    ...
    \node[draw, rectangle, line width=1pt, align=center] (feature) at (53,25) {
        \begin{tabular}{c}
            ...
            \begin{tikzpicture}[scale=0.12]
                ...
                \node[draw, rectangle, rounded corners=2pt, align=center] (n1) at (-10,26) {$\text{clear}_\text{goal}(\kern-3pt\raisebox{-4pt}{\block{0.12}{white}{?}}\kern-3pt)$};
                \node[draw, rectangle, rounded corners=2pt, align=center] (n2) at (10,26) {$\boldsymbol{\neg}$};
                \node[draw, rectangle, rounded corners=2pt, align=center] (n3) at (10,18) {clear(\kern-3pt\raisebox{-4pt}{\block{0.12}{white}{?}}\kern-3pt)};
    ...
    \node[draw, rectangle, line width=1pt, align=center] (valuation) at (88,25) {
        \begin{tabular}{c}
            Valuation \\
            \hline
            $\{\kern-3pt\raisebox{-4pt}{\block{0.12}{red}{}}\kern-3pt,\kern-3pt\raisebox{-4pt}{\block{0.12}{green}{}}\kern-3pt\}$
        \end{tabular}
    };
